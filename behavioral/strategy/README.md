...
This directory contains three implementations of the Strategy pattern:
...
```python
# Basic usage
from behavioral.strategy.basic import *

# Practical usage  
from behavioral.strategy.practical import *

# Advanced usage
from behavioral.strategy.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/behavioral/strategy.md)
