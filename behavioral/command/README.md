...
This directory contains three implementations of the Command pattern:
...
```python
# Basic usage
from behavioral.command.basic import *

# Practical usage  
from behavioral.command.practical import *

# Advanced usage
from behavioral.command.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/behavioral/command.md)
