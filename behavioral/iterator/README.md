...
This directory contains three implementations of the Iterator pattern:
...
```python
# Basic usage
from behavioral.iterator.basic import *

# Practical usage  
from behavioral.iterator.practical import *

# Advanced usage
from behavioral.iterator.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/behavioral/iterator.md)
