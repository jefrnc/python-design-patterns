...
This directory contains three implementations of the Factory Method pattern:
...
```python
# Basic usage
from creational.factory_method.basic import *

# Practical usage  
from creational.factory_method.practical import *

# Advanced usage
from creational.factory_method.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/creational/factory_method.md)
