...
This directory contains three implementations of the Prototype pattern:
...
```python
# Basic usage
from creational.prototype.basic import *

# Practical usage  
from creational.prototype.practical import *

# Advanced usage
from creational.prototype.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/creational/prototype.md)
