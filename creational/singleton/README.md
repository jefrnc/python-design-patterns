...
This directory contains three implementations of the Singleton pattern:
...
```python
# Basic usage
from creational.singleton.basic import *

# Practical usage  
from creational.singleton.practical import *

# Advanced usage
from creational.singleton.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/creational/singleton.md)
