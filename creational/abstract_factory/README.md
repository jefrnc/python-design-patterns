...
This directory contains three implementations of the Abstract Factory pattern:
...
```python
# Basic usage
from creational.abstract_factory.basic import *

# Practical usage  
from creational.abstract_factory.practical import *

# Advanced usage
from creational.abstract_factory.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/creational/abstract_factory.md)
