...
This directory contains three implementations of the Flyweight pattern:
...
```python
# Basic usage
from structural.flyweight.basic import *

# Practical usage  
from structural.flyweight.practical import *

# Advanced usage
from structural.flyweight.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/structural/flyweight.md)
