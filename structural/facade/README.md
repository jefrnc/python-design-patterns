...
This directory contains three implementations of the Facade pattern:
...
```python
# Basic usage
from structural.facade.basic import *

# Practical usage  
from structural.facade.practical import *

# Advanced usage
from structural.facade.advanced import *
```
...
- [Pattern Documentation](../../docs/patterns/structural/facade.md)
